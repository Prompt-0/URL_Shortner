    ...
    <div class="glass-card">
      <form action="/shorten" method="post">
        ...
        <div class="form-group">
          ...
          <input id="custom_code" name="custom_code" type="text" placeholder="e.g. my-link" minlength="3" maxlength="32" pattern="[A-Za-z0-9_\-]+" title="Only letters, numbers, hyphens, and underscores. 3 to 32 characters.">
        </div>
