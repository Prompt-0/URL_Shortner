    ...
    <div class="glass-card">
      <form action="/shorten" method="post">
        ...
        <div class="form-group">
          ...
          <div id="custom_code_help" style="font-size: 0.85rem; color: var(--text-muted); margin-top: 0.5rem; line-height: 1.4;">3-32 characters (letters, numbers, hyphens, underscores only)</div>
        </div>
