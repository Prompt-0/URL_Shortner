    ...
    <div class="glass-card">
      <form action="/shorten" method="post">
        ...
        <div class="form-group">
          ...
          <div id="custom_code_help" style="color: var(--text-muted); font-size: 0.8rem; margin-top: 0.3rem;">Must be 3-32 characters, using only letters, numbers, hyphens, and underscores</div>
        </div>
