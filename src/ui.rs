    ...
    <div class="glass-card">
      <form action="/shorten" method="post">
        ...
        <div class="form-group">
          ...
          <input id="custom_code" name="custom_code" type="text" placeholder="e.g. my-link" minlength="3" maxlength="32" pattern="[a-zA-Z0-9\-_]+" title="Custom alias must be between 3 and 32 characters, containing only letters, numbers, hyphens, and underscores.">
        </div>
