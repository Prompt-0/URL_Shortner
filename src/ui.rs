    ...
    <div class="glass-card">
      <form action="/shorten" method="post">
        <div class="form-group">
          ...
          <input id="url" name="url" type="url" placeholder="https://example.com/very-long-url" pattern="https?://.*" title="Must start with http:// or https://" required>
        </div>
        <div class="form-group">
          <label for="custom_code">Custom Alias (Optional)</label>
          <input id="custom_code" name="custom_code" type="text" placeholder="e.g. my-link" minlength="3" maxlength="32" pattern="[a-zA-Z0-9\-_]+" title="May only contain letters, numbers, hyphens, and underscores">
        </div>
