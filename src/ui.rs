    ...
    <div class="glass-card">
      <form action="/shorten" method="post">
        ...
        <div class="form-group">
          ...
          <span id="custom_code_help" class="helper-text">Must be 3-32 characters, using only letters, numbers, hyphens, and underscores.</span>
        </div>
    ...
    <div class="glass-card">
      ...
      <div class="details">
        ...
        <div class="detail-row">
          ...
          <span class="detail-value" style="max-width: 200px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; display: inline-block; vertical-align: bottom;" title="{original_url}" tabindex="0">{original_url}</span>
        </div>
        <div class="detail-row">
