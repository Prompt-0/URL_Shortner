    ...
    <div class="glass-card">
      <form action="/shorten" method="post">
        ...
        <div class="form-group">
          ...
          <input id="custom_code" name="custom_code" type="text" placeholder="e.g. my-link" minlength="3" maxlength="32" pattern="[a-zA-Z0-9_-]+" title="Custom code may only contain letters, numbers, hyphens, and underscores">
        </div>
