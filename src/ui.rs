    ...
    <div class="glass-card">
      <form action="/shorten" method="post">
        ...
        <div class="form-group">
          ...
          <input id="custom_code" name="custom_code" type="text" placeholder="e.g. my-link" pattern="[a-zA-Z0-9\-_]+" minlength="3" maxlength="32" title="3-32 characters, only letters, numbers, hyphens, and underscores" aria-describedby="custom_code_help">
          <div id="custom_code_help" style="margin-top: 0.5rem; color: var(--text-muted); font-size: 0.85rem;">3-32 chars: letters, numbers, -, _</div>
        </div>
